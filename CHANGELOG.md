...
### Security
- Updated `pyo3` dependency from `0.22` to `0.29.0` in `tempus-engine-py` to fix security vulnerabilities (`RUSTSEC-2025-0020` and `RUSTSEC-2026-0177`).
- Removed outdated vulnerability ignores from `cargo audit` in CI pipeline.
